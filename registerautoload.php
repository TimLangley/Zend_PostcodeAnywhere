...
define('APPLICATION_PATH', 		realpath(dirname(__FILE__)).'/src/main/php/Postcode');
define('TEST_PATH',				realpath(dirname(__FILE__)).'/src/test/php/Postcode/');
...
defined('APPLICATION_PATH') 	or define('APPLICATION_PATH', 	realpath(dirname(__FILE__)).'/src/main/php/Postcode');

require_once "Zend/Loader/Autoloader.php";
$autoloader = Zend_Loader_Autoloader::getInstance();
$autoloader->registerNamespace('PHPUnit_');
$autoloader->registerNamespace('Zend_');
$autoloader->registerNamespace('Postcode_');
